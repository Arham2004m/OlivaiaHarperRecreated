      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="flex flex-col lg:flex-row gap-16 md:gap-32 items-center">
          <div className="w-full lg:w-1/2">
            ...
            <Reveal delay={0.1}>
              <h2 className="text-4xl md:text-7xl font-serif leading-[1.1] tracking-tight mb-12">
                Expert Team
              </h2>
            </Reveal>
            <Reveal delay={0.2}>
              <h3 className="text-2xl md:text-3xl font-serif mb-8 text-accent">
                Built on Experience. <br />Driven by Perspective.
              </h3>
            </Reveal>
            <Reveal delay={0.3}>
            ...
            <Reveal delay={0.4}>
              <div className="flex gap-12 border-t border-border pt-12">
                <div>
                  <h4 className="text-[10px] uppercase tracking-widest font-bold mb-2">Projects</h4>
                  <p className="text-3xl font-serif">50+</p>
                </div>
                <div>
                  <h4 className="text-[10px] uppercase tracking-widest font-bold mb-2">Experience</h4>
                  <p className="text-3xl font-serif">20 Yrs</p>
                </div>
              </div>
            </Reveal>
          </div>
